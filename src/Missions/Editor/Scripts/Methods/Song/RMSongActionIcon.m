...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        _musicNote1 = [[UIImageView alloc] initWithImage:[UIImage cacheableImageNamed:@"iconMusicNote.png"]];
        self.musicNote1.center = CGPointMake(18, 38);
        [self.contentView addSubview:self.musicNote1];
        
        _musicNote2 = [[UIImageView alloc] initWithImage:[UIImage cacheableImageNamed:@"iconMusicNote.png"]];
        ...
        _musicNote3 = [[UIImageView alloc] initWithImage:[UIImage cacheableImageNamed:@"iconMusicNote.png"]];
